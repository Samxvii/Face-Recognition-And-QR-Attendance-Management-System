...
image = Image.open("C:\\Users\\sansk\\OneDrive\\Desktop\\New folder\\Attendace_management_system-master\\5.jpg")  
...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
        ec.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
        ec.title('Warning!!')
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='window', password='', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
            ...
            def create_csv():
                ...
                csv_name='C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
                ...
                import tkinter
                window = tkinter.Tk()
                window.title("Attendance of " + subb)
                ...
                with open(csv_name, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(window, width=13, height=1, fg="black", font=('times', 13, ' bold '),
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def err_screen():
    ...
    sc1.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
    sc1.title('Warning!!')
...
def err_screen1():
    ...
    sc2.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
    sc2.title('Warning!!')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier('C:/Users/sansk/AppData/Local/Programs/Python/Python311/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
            ...
            with open('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/TrainingImageLabel/Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = "C:/Users/sansk/AppData/Local/Programs/Python/Python311/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv("C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                timeStamp = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
                Hour, Minute, Second = timeStamp.split(":")
                fileName = "C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/Attendance/" + Subject + "_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
                attendance = attendance.drop_duplicates(['Enrollment'], keep='first')
                print(attendance)
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='window', password='', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                import tkinter
                window = tkinter.Tk()
                window.title("Attendance of " + Subject)
                window.configure(background='snow')
                cs = '' + fileName
                with open(cs, newline="") as file:
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            # i've added some styling
                            label = tkinter.Label(window, width=8, height=1, fg="black", font=('times', 15, ' bold '),
                                                  bg="lawn green", text=row, relief=tkinter.RIDGE)
                            label.grid(row=r, column=c)
                            c += 1
                        r += 1
    ...
    windo = tk.Tk()
    windo.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/Attendance/-------Check atttendance-------"')
...
def admin_panel():
    win = tk.Tk()
    win.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
    win.title("LogIn")
...
def trainimg():
    ...
    try:
        global faces,Id
        faces, Id = getImagesAndLabels("C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/TrainingImage")
    except Exception as e:
    ...
    try:
        recognizer.save("C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/TrainingImageLabel/Trainner.yml")
    except Exception as e:
...
window.iconbitmap('C:/Users/sansk/OneDrive/Desktop/New folder/Attendace_management_system-master/AMS.ico')
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="dodger blue", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="RoyalBlue1", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="RoyalBlue1", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="snow", fg="black", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="royal blue"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="royal blue"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="MediumPurple1"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="DodgerBlue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="DodgerBlue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendace",fg="black",command=subjectchoose  ,bg="DodgerBlue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="DodgerBlue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
